...
class S1ForegroundService : LifecycleService() {
    ...
    override fun onCreate() {
        ...
        lifecycleScope.launch { app.bleManager.state.collect { updateNotification(it.phase) } }
    }
    ...
    companion object { const val ACTION_STOP = "com.kerberosclaw.myairs1.STOP"; private const val CHANNEL_ID = "myair_ble"; private const val NOTIFICATION_ID = 1001 }
}
